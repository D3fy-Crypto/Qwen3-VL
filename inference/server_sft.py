"""
FastAPI inference server for the fine-tuned Qwen3-VL SFT model.
...
DEFAULT_MODEL_PATH = "/home/chang/vla/models/qwen3vl-sft-20260519-2207"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Qwen3-VL SFT model inference server")
...
async def lifespan(app: FastAPI):
    ...
    # The SFT checkpoint includes a saved processor (processor.save_pretrained was called
    # during training), so AutoProcessor.from_pretrained works directly from the checkpoint.
...
app = FastAPI(title="Qwen3-VL SFT Inference Server", lifespan=lifespan)
